...
def retorna(lista):
    ...
    for linha in lista:
        if linha[3] == 'm':
            string = f'''{linha[0]};{linha[1]}{linha[2]};{linha[3]};{linha[4]};{linha[5]}\n '''
            lista_homens.append(string)
        else:
            string = f'''{linha[0]};{linha[1]}{linha[2]};{linha[3]};{linha[4]};{linha[5]}\n '''
            lista_mulheres.append(string)
    lista_tudo.append(lista_mulheres)
    lista_tudo.append(lista_homens)
...
lista1 = retorna(lista)
print(f'Quantidade de mulheres {len(lista1[0])}')
print(f'Quantidade de homens {len(lista1[1])}')