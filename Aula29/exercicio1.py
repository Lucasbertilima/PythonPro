...
aviao = []
terminal = ['piloto','oficial1','oficial2','chefe de serviço','comissária1','comissária2','policial','presidiário']
fortwo = []

def embarquetwo(passageiro1,passageiro2):
    fortwo.append(passageiro1)
    fortwo.append(passageiro2)
...
nome1 = input('Qual o nome de quem vai dirigir o fortwo')
nome2 = input('quem vai ser o passageiro')