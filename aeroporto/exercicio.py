...
def adicinar_motorista(opcao, passeiro, vaero, aviao) :   
    if opcao == '1':
        if vaero == False:
            ...
            if piloto != 'piloto' or piloto != 'chefe de serviço' or piloto != 'policial':
                print('A pessoa selecionada não pode dirigir o carro')
                print('Podem dirigir Piloto chefe de serviço e policial')
                contador = 0
                for i in terminal:
                    print(contador, i)
                    contador += 1
